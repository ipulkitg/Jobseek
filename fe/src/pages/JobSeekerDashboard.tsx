...
const JobSeekerDashboard: React.FC = () => {
          ...
          <div className="welcome-section">
            {!profileLoading && !hasProfile && (
              <div style={{
                ...
                <div>
                  <h3 style={{ margin: '0 0 4px 0', color: '#92400e' }}>Complete your profile</h3>
                  <p style={{ margin: 0, color: '#92400e' }}>Add your details to improve your job applications and get better matches</p>
                </div>
                <button
            ...
            <div className="recent-applications" style={{ marginTop: '48px' }}>
  ...
  return (
    <div className="job-seeker-dashboard" style={{ minHeight: '100vh', backgroundColor: '#f8f9fa' }}>
      <header className="dashboard-header" style={{
        ...
        <h1 style={{ margin: 0, fontSize: '24px', fontWeight: '600' }}>Job Seeker Dashboard</h1>
